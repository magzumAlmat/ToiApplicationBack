...
//     WeddingItem,      // ← ДОБАВИТЬ
//   Wishlist,         // ← ДОБАВИТЬ (это решит текущую ошибку!)
//   User,             // ← ДОБАВИТЬ
// };
...
db.Wishlist.belongsTo(db.Goods, { foreignKey: 'good_id', as: 'Good' });
db.Goods.hasMany(db.Wishlist, { foreignKey: 'good_id' });
...
module.exports = {
  ...
  BusinessAvailability,
  Wedding,
  WeddingItem: db.WeddingItem,      // ← Экспортируем из db
  Wishlist: db.Wishlist,            // ← Экспортируем из db
  User: db.User,                    // ← Экспортируем из db
  Goods,
  TechnicalEquipmentRental,
  Typography,
  Hotel,
